        ...
        <ScrollView className={`flex-1 ${isDarkMode ? 'bg-[#151718]' : 'bg-[#DFEDF1]'}`}>
            ...
            <View className={`${isDarkMode ? 'bg-[#1F2123]' : 'bg-white'} p-4 rounded-3xl`}>
                <View className='mt-2'>
                    ...
                    {[1, 2, 3].map((item) => (
                        <View key={item} className={`${isDarkMode ? 'bg-[#2A2D2E]' : 'bg-[#E4F8F3]'} p-4 rounded-3xl shadow-sm mb-3`}>
                            <View className="flex-row items-start mb-2">
                                <View className="w-10 h-10 bg-green-50 p-7 rounded-full flex items-center justify-center -mt-1">
                                    <StatusIcon />
                                </View>
